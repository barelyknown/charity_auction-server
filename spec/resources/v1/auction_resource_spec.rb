module V1
  RSpec.describe AuctionResource do
    ...
    it "has the expected fetchable attributes" do
      expect(subject.fetchable_fields.sort).to eq (creatable_fields + [:id, :created_at, :updated_at, :donations, :donors, :tickets, :bidders, :bid_groups, :auction_items, :payments]).sort
    end
